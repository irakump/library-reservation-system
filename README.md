...
Sprint 7 focused on functional and non-functional testing. Backend unit tests coverage reached 81.3%. SonarQube analysis achieved A grades across all categories. Non-functional testing included user acceptance testing, heuristic evaluation, accessibility testing include Lighthouse, Accessibility Insights for Web, WAVE, and WCAG contrast checker and end-to-end testing with Playwright.
